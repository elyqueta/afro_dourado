...
- Pequeno label maiúsculo com tracking largo (`AFRODOURADO`, `01`, `TRICOLOGIA`), cor configurável
  (`ink` | `gold` | `cream`).
...
6. `BookingSummaryComponent` — resumo + "Confirmar pedido" (submete para
   `[[PENDENTE-INTEGRACAO]]` — endpoint/serviço de submissão a definir pela AfroDourado; até lá,
