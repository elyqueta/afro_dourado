...
@Component({
  ...
  template: `
    @if (visible()) {
      <div class="bar">
        <a routerLink="/agendamento" class="primary">Agendar atendimento</a>
        <a href="https://wa.me/244XXXXXXXXX" target="_blank" rel="noopener noreferrer" class="secondary" aria-label="Conversar no WhatsApp">
