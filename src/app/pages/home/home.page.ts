  ...
  template: `
    <main>
      ...
      >
        ...
        <app-pill-button href="#sobre" variant="secondary" size="lg" label="Descobrir a AfroDourado"></app-pill-button>
      </app-hero>

      <app-brand-story-reveal text="O teu cabelo conta uma história. Nós ajudamos a escrevê-la com ciência, técnica e produtos naturais." imageSrc="https://images.pexels.com/photos/3190174/pexels-photo-3190174.jpeg?auto=format&fit=crop&w=800&q=80" />
...
export class HomePage {
  ...
  readonly products = [
    { name: 'Óleo Capilar Nutritivo', benefits: 'Hidrata profundamente, reduz quebra e facilita o desembaraço.', usage: 'Aplicar no couro cabeludo e comprimentos antes do shampoo.', image: 'https://images.pexels.com/photos/3735643/pexels-photo-3735643.jpeg?auto=format&fit=crop&w=600&q=80' },
    { name: 'Shampoo Natural', benefits: 'Limpa suavemente sem ressecar, respeita a oleosidade natural.', usage: 'Massajar no couro cabeludo molhado e enxaguar abundantemente.', image: 'https://images.pexels.com/photos/3998012/pexels-photo-3998012.jpeg?auto=format&fit=crop&w=600&q=80' },
    { name: 'Finalizador', benefits: 'Define cachos e tranças, controla o frizz e protege da humidade.', usage: 'Aplicar uma pequena quantidade nas pontas e moldar com as mãos.', image: 'https://images.pexels.com/photos/6625874/pexels-photo-6625874.jpeg?auto=format&fit=crop&w=600&q=80' },
  ];

  readonly team = [
    { name: 'Ana Luísa Mendes', role: 'Tricologista', bio: 'Especialista em avaliação capilar e tratamentos personalizados.', photo: 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=format&fit=crop&w=600&q=80' },
    { name: 'Carlos Eduardo', role: 'Especialista em Tranças', bio: 'Técnico em penteados protectivos e tranças Nagô.', photo: 'https://images.pexels.com/photos/1516680/pexels-photo-1516680.jpeg?auto=format&fit=crop&w=600&q=80' },
    { name: 'Mariana Costa', role: 'Terapeuta Capilar', bio: 'Focada em hidratação profunda e recuperação de danos.', photo: 'https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=format&fit=crop&w=600&q=80' },
  ];

  readonly articles = [
    { title: 'Queda capilar: quando procurar ajuda', excerpt: 'Entenda os sinais que indicam a necessidade de uma avaliação tricológica.', image: 'https://images.pexels.com/photos/3735643/pexels-photo-3735643.jpeg?auto=format&fit=crop&w=600&q=80', slug: 'queda-capilar' },
    { title: 'Rotina de cuidados para cabelo afro no dia a dia', excerpt: 'Dicas práticas para manter a hidratação e definição entre consultas.', image: 'https://images.pexels.com/photos/3998012/pexels-photo-3998012.jpeg?auto=format&fit=crop&w=600&q=80', slug: 'cuidados-cabelo-afro' },
    { title: 'Tranças: estilo, protecção e identidade', excerpt: 'Como os penteados protectivos podem fortalecer o cabelo e expressar cultura.', image: 'https://images.pexels.com/photos/16089262/pexels-photo-16089262.jpeg?auto=format&fit=crop&w=600&q=80', slug: 'trancas-estilo-proteccao' },
  ];
