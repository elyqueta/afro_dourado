...
@Component({
  ...
  template: `
    <main class="section-y container-max">
      <app-section-heading eyebrow="Tricologia" title="Compreender o cabelo é o primeiro passo para cuidar dele." size="display-m" />
        ...
        @for (treatment of treatments; track treatment.id) {
          <div class="treatment">
            ...
            <div class="info">
              ...
              <button type="button" class="details-toggle" (click)="toggle(treatment.id)" [attr.aria-expanded]="expanded() === treatment.id">
